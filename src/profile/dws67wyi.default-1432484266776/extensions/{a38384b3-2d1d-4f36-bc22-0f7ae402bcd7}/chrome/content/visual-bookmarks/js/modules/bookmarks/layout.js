...
//
//                asyncFavicons.getFaviconDataForPage(nodeURI, function(data) {
...
//                });
            ...
            app.core.events.register({'sqliteStorage': onStorageUpdate},'#bookmarks');
            //app.core.sqliteStorage.onStorageUpdate(onStorageUpdate);
